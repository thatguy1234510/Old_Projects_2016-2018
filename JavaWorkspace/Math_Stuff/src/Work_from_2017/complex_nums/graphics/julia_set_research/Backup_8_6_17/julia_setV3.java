//package Work_in_2017.complex_nums.graphics.julia_set_research.Backup_8_6_17;
//
...
//
//public class julia_setV3 {
//
//    public Complex C;
//
//    public julia_setV3(Complex crit) {
//        this.C = crit;
//    }
//
...
//                    for (int i = PartStartX; i < PartStartX + PartWidth; i++) {
//                        for (int j = PartStartY; j < PartStartY + PartHeight; j++) {
...
//                        }
//                    }
//                    // System.out.println("i finished my partition, i am
//                    // "+threadName);
...
//        }
//
//        for (Thread thread : ImageWriter_threads) {
//            thread.join();
//        }
//        // SHOULD pause main thread until the final ImageWriter thread terminates
